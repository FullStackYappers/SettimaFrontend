const KeyStaff = () => {
  return (
    <div className="specificCast text-lg font-semibold flex flex-col justify-between gap-2">
      <div className="rounded-custom bg-secondary w-full flex flex-col justify-center items-center p-4">
